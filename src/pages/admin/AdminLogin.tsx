...
import { ArrowRight, Loader2, User, Mail, Lock, ShieldCheck, ChevronLeft } from "lucide-react";
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight">
                        {isLogin ? "Admin Portal" : "Admin Access Request"}
                    </h2>
                ...
                <Card className="glass-card p-8 border-white/10">
                    <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {!isLogin && (
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <ShieldCheck className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-foreground/70" />
                                            <Input
                                                id="username"
                        ...
                        <Button
                            type="submit"
                            className="w-full h-12 bg-admin hover:bg-admin/90 text-primary-foreground border-0 shadow-glow mt-6"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                    ...
                    <div className="mt-6 text-center">
                        <button
                            ...
                            className="text-sm text-foreground/70 hover:text-admin transition-colors"
                        >
                            {isLogin
